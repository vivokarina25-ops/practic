...
# 4.21. Проверить, принадлежит ли число, введенное с клавиатуры, интервалу (–5, 3)
print('4.21') 
number = int(input('Введите число: '))
if -5 < number < 3:
    print('Число принадлежит интервалу от -5 до 3')
else:
    print('Число не принадлежит интервалу от -5 до 3')
print()
...
# 4.23. Даны три вещественных числа a, b, c. Проверить:
...
# 4.24. Определить, является ли число а делителем числа b или, наоборот, число b делителем числа а. 
...
# 4.25. Определить, верно ли, что при делении неотрицательного целого числа a на положительное 
...
# 4.26. Даны три вещественных числа a, b, c. 
...
# 4.27. Вася пытается высунуть голову в форточку размерами a и b см. 
...
if a >= d + 1 and b >= d + 1:
    print('Вася сможет просунуть голову в форточку')
else:
    print('Вася не сможет просунуть голову в форточку!')

print()

# 4.28. Даны вещественные положительные числа a, b, c, x, y. 
# Выяснить, пройдет ли кирпич с ребрами a, b, c в прямоугольное отверстие со сторонами x и y. 
# Просовывать кирпич в отверстие разрешается только так, чтобы каждое из его ребер было 
# параллельно или перпендикулярно каждой из сторон отверстия.
print('4.28') 

a = int(input('Введите ребро1: '))
b = int(input('Введите ребро2: '))
c = int(input('Введите ребро3: '))
x = int(input('Введите сторону1 отверстия: '))
y = int(input('Введите сторону2 отверстия: '))

if (a+b)*2 < (x+y)*2 or (a+c)*2 < (x+y)*2 or (b+c)*2 < (x+y)*2:
...
if (number // 100 == 4 or 7) or (number // 10 % 10 == 4 or 7) or (number % 10 == 4 or 7):
    print("Цифры 4 или 7 входят в число")
else:
    print("Цифры 4 или 7 не входят в число")

if (number // 100 == 3 or 6 or 9) or (number // 10 % 10 == 3 or 6 or 9) or (number % 10 == 3 or 6 or 9):
    print("Цифры 3 или 6 или 9 входят в число")
else:
    print("Цифры 3 или 6 или 9 не входят в число")
print()

# 4.32. Дано натуральное число n (n 9999). 
# Выяснить, является ли оно палиндромом ("перевертышем") с учетом четырех цифр, 
# как, например, числа 7777, 8338, 0330 и т. п.
...
# 4.35. Определить, является ли заданное шестизначное число счастливым. 
# (Счастливым называют такое шестизначное число, что сумма его первых трех цифр равна сумме его последних трех цифр.) 


# 4.36. Год является високосным, если его номер кратен 4, однако из кратных 100 високосными являются лишь кратные 400, 
